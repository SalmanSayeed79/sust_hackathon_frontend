...
export default function ProductDetails({ nextStep }) {
    ...
    const [brand, setBrand] = useState("Weinberner")
        ...
        <>
            ...
            <div class="flex w-full flex-col items-center mx-4 mt-2 p-6 bg-white border border-gray-200 rounded-lg shadow  dark:bg-gray-800 dark:border-gray-700 ">
                <div className="flex flex-col items-center">
                    ...
                    <h5 class="mb-2 text-3xl font-bold tracking-tight text-gray-900 dark:text-white">✨ Male Formal Shoes ✨</h5>
            ...
            {doneGeneration && <div className='flex w-full flex-col  items-center mx-4 mt-2 p-6 bg-white border border-gray-200 rounded-lg shadow  dark:bg-gray-800 dark:border-gray-700 '>
                <form className='w-full'>
                    ...
                    <div className="flex items-center overflow-x-scroll no-scrollbar">
                        {images.map(a=>(
                            <div class="flex max-w-sm p-2 mx-2 items-center bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:text-white text-center dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                            <input type="checkbox" className='mr-2'/>
                            <img className='hidden md:flex' src={a.url} style={{ width: "200px" }} />
                            <img className='flex md:hidden' src={a.url} style={{ width: "100px" }} />
                    ...
                    <div class="mb-6">
                        ...
                        {!editTitle && <div className=" flex items-center ">
                            <h4 for="title" class="block mb-2 text-xl font-semibold text-gray-900 dark:text-white mr-2">{title}</h4>
                        ...
                        {editTitle && <div class="relative w-full ">
                            <input onChange={(e) => setTitle(e.target.value)} value={title} type="text" class="block p-2.5 w-full z-20 text-sm text-gray-900 bg-gray-50 rounded-e-lg border border-gray-300 focus:ring-orange-500 focus:border-orange-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:border-orange-500" />
                    ...
                    {!editDescription && <MDEditor.Markdown source={description} style={{ padding: "2rem", background: "transparent" }} />}
                    {editDescription && <div class="w-full mb-4 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
                        <div class="px-4 py-2 bg-white rounded-t-lg dark:bg-gray-800">
                            ...
                            <textarea value={description} onChange={e=>setDescription(e.target.value)} id="comment" rows="4" class="w-full px-0 text-sm text-gray-900 bg-white border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400" placeholder="Write your post..." ></textarea>
                        </div>
